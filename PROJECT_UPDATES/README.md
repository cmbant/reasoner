...
Original snapshot date: 2026-09-04. Source-authority migration synchronized: 2026-09-05. Latest cross-repository handoff: **2026-09-20**.

**Current manuscript/source authority is `cmbant/QIprojects:main`.** This directory is retained as the Lean-side audit ledger and historical formalization record. Lean is maintained in `cmbant/reasoner:master`; the former `formal-research-lean` branch was squash-merged into `master` on 2026-09-20. Do not copy manuscript/source authority back into this repository.

## Start here

For current status, read:

- `LEAN_4_34_SQUASH_2026-09-20.md` — current cross-repository pins, Lean 4.34.0 workflow result, and post-merge branch policy.

- `HANDOFF_2026-09-07.md` — historical exact QIprojects/reasoner heads, Endpoint14 status, latest aggregate blockers, and the QIprojects T20 Lean roadmap at that date.
