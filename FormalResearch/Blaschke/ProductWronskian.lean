...
def selectedProductWronskian (I S : Finset ι) (a b : ι → ℂ[X]) : ℂ[X] :=
...
lemma selectedProductWronskian_insert (I S : Finset ι) (a b : ι → ℂ[X])
  ...
  rw [selectedFactor_mul_complementary]
